...
state(['navigationMenu' => app(Navigation::class)->tree()]);
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                                        <x-dropdown-link href="{{ route('teams.create') }}" wire:navigate="true">
                                            {{ __('Create New Team') }}
                                        </x-dropdown-link>
                                    @endcan
                ...
                <div class="relative ms-3">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('profile.show') }}" wire:navigate="true">
                                {{ __('Profile') }}
                            </x-dropdown-link>

                            @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                                <x-dropdown-link href="{{ route('api-tokens.index') }}" wire:navigate="true">
                                    {{ __('API Tokens') }}
                                </x-dropdown-link>
                            @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" wire:navigate="true">
                {{ __('Dashboard') }}
            </x-responsive-nav-link>

            @foreach ($navigationMenu as $item)
                <x-responsive-nav-link :href="$item['url']" :active="$item['active']" wire:navigate="true">
                    {{ $item['title'] }}
                </x-responsive-nav-link>
            @endforeach
        </div>
